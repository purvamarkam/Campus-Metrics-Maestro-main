...
Globalize.b809169210 = messageFormatterFn((function(  ) {
  return function(d) { return "It looks like you switched to a new data source since I made that suggestion. Switch back to the original data source, or scroll up and click the Suggestions button again and I'll create some new suggestions."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a322704075 = messageFormatterFn((function(  ) {
  return function(d) { return " Generative AI can produce inaccurate or harmful responses. Review output for accuracy and safety. You assume responsibility for how the outcomes of Tableau Agent are applied to your organization."; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1254380598 = messageFormatterFn((function(  ) {
  return function(d) { return "If used, this measure won't be broken down by the following combination of dimensions in the viz:"; }
})(), Globalize("en").pluralGenerator({}));
...
Globalize.a1659900459 = messageFormatterFn((function(  ) {
  return function(d) { return "This measure can't be simultaneously broken down by the following combination of dimensions:"; }
})(), Globalize("en").pluralGenerator({}));
